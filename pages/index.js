      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sm text-balance xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16"
          >
            I am a Full Stack Developer with skills in web development, machine
            learning. Check out my projects and skills.
          </motion.p>
